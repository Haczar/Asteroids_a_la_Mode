...
AShip_C__pf668171628::AShip_C__pf668171628(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (AShip_C__pf668171628::StaticClass() == GetClass()))
	{
		AShip_C__pf668171628::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	bpv__DefaultSceneRoot__pf->RelativeScale3D = FVector(0.410000, 0.410000, 0.410000);
	...
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AShip_C__pf668171628::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__StaticMesh__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__StaticMesh__pf->OverrideMaterials.Reserve(1);
	bpv__StaticMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AShip_C__pf668171628::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	...
	bpv__StaticMesh__pf->RelativeScale3D = FVector(0.390000, 0.500000, 0.500000);
	...
	bpv__Thruster__pf->Template = CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(AShip_C__pf668171628::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	...
	bpv__Rotation_Constant__pf = 3.200000f;
	bpv__ThurstForce_Constant__pf = 0.204000f;
...
void AShip_C__pf668171628::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AShip_C__pf668171628::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(LoadObject<UEnum>(nullptr, TEXT("/Game/Pawns/Ship/SRotate.SRotate")));
	...
	__Local__5.InputActionName = FName(TEXT("Rotate Left"));
	__Local__5.InputKeyEvent = EInputEvent::IE_Released;
	__Local__5.FunctionNameToBind = FName(TEXT("InpActEvt_Rotate Left_K2Node_InputActionEvent_10"));
	auto& __Local__6 = __Local__3->InputActionDelegateBindings[1];
	__Local__6.InputActionName = FName(TEXT("Rotate Left"));
	__Local__6.FunctionNameToBind = FName(TEXT("InpActEvt_Rotate Left_K2Node_InputActionEvent_9"));
	auto& __Local__7 = __Local__3->InputActionDelegateBindings[2];
	__Local__7.InputActionName = FName(TEXT("Fire Weapon"));
	__Local__7.FunctionNameToBind = FName(TEXT("InpActEvt_Fire Weapon_K2Node_InputActionEvent_13"));
	auto& __Local__8 = __Local__3->InputActionDelegateBindings[3];
	__Local__8.InputActionName = FName(TEXT("Thrust"));
	__Local__8.InputKeyEvent = EInputEvent::IE_Released;
	__Local__8.FunctionNameToBind = FName(TEXT("InpActEvt_Thrust_K2Node_InputActionEvent_8"));
	auto& __Local__9 = __Local__3->InputActionDelegateBindings[4];
	__Local__9.InputActionName = FName(TEXT("Rotate Right"));
	__Local__9.InputKeyEvent = EInputEvent::IE_Released;
	__Local__9.FunctionNameToBind = FName(TEXT("InpActEvt_Rotate Right_K2Node_InputActionEvent_12"));
	auto& __Local__10 = __Local__3->InputActionDelegateBindings[5];
	__Local__10.InputActionName = FName(TEXT("Rotate Right"));
	__Local__10.FunctionNameToBind = FName(TEXT("InpActEvt_Rotate Right_K2Node_InputActionEvent_11"));
	auto& __Local__11 = __Local__3->InputActionDelegateBindings[6];
	__Local__11.InputActionName = FName(TEXT("Thrust"));
	__Local__11.FunctionNameToBind = FName(TEXT("InpActEvt_Thrust_K2Node_InputActionEvent_7"));
...
PRAGMA_ENABLE_OPTIMIZATION
void AShip_C__pf668171628::bpf__ExecuteUbergraph_Ship__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	b0l__K2Node_DynamicCast_AsUser_Data__pf = Cast<AUserData_C__pf4061722237>(((::IsValid(b0l__K2Node_DynamicCast_AsReg_User__pf)) ? (b0l__K2Node_DynamicCast_AsReg_User__pf->PlayerState) : (__Local__13)));
	b0l__K2Node_DynamicCast_bSuccess4__pf = (b0l__K2Node_DynamicCast_AsUser_Data__pf != nullptr);;
	FName  __Local__14 = FName();
	bpfv__CallFunc_Conv_NameToString_ReturnValue__pf = UKismetStringLibrary::Conv_NameToString(((::IsValid(b0l__K2Node_DynamicCast_AsUser_Data__pf)) ? (b0l__K2Node_DynamicCast_AsUser_Data__pf->bpv__PlyrxName__pfT) : (__Local__14)));
	...
	bpf__DestroyedxxServerxSidexStuff__pf3TTT();
	return; //KCST_EndOfThread
}
void AShip_C__pf668171628::bpf__ExecuteUbergraph_Ship__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 50:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("Detected a overlap from static mesh.")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
			}
		case 51:
			{
				b0l__K2Node_DynamicCast_AsAsteroid__pf = Cast<AAsteroid_C__pf2772898577>(b0l__K2Node_ComponentBoundEvent_OtherActor__pf);
				b0l__K2Node_DynamicCast_bSuccess1__pf = (b0l__K2Node_DynamicCast_AsAsteroid__pf != nullptr);;
		...
		case 52:
			{
				...
				b0l__K2Node_DynamicCast_AsReg_User__pf = Cast<ARegUser_C__pf4061722237>(bpfv__CallFunc_GetController_ReturnValue__pf);
				b0l__K2Node_DynamicCast_bSuccess3__pf = (b0l__K2Node_DynamicCast_AsReg_User__pf != nullptr);;
		...
		case 54:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("Fail on getting controller for pawn.")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
				__CurrentState = -1;
				break;
			}
		case 55:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsAlien__pf != nullptr);;
...
void AShip_C__pf668171628::bpf__ExecuteUbergraph_Ship__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	ABP_Projectile_C__pf668171628* bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf{};
	...
	bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, ABP_Projectile_C__pf668171628::StaticClass(), bpfv__CallFunc_GetSocketTransform_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::Undefined, bpfv__CallFunc_GetOwner_ReturnValue__pf);
	...
	bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf = CastChecked<ABP_Projectile_C__pf668171628>(UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf, bpfv__CallFunc_GetSocketTransform_ReturnValue__pf), ECastCheckedType::NullAllowed);
	return; //KCST_EndOfThread
}
void AShip_C__pf668171628::bpf__ExecuteUbergraph_Ship__pf_3(int32 bpp__EntryPoint__pf)
{
...
void AShip_C__pf668171628::bpf__ExecuteUbergraph_Ship__pf_4(int32 bpp__EntryPoint__pf)
{
...
void AShip_C__pf668171628::bpf__ExecuteUbergraph_Ship__pf_5(int32 bpp__EntryPoint__pf)
{
	...
	b0l__K2Node_DynamicCast_bSuccess2__pf = (b0l__K2Node_DynamicCast_AsDebug_Mode__pf != nullptr);;
	...
	{
		b0l__K2Node_DynamicCast_AsDebug_Mode__pf->bpf__ShipxDestroyed__pfT(b0l__K2Node_DynamicCast_AsReg_User__pf);
	}
	return; //KCST_EndOfThread
}
void AShip_C__pf668171628::bpf__ExecuteUbergraph_Ship__pf_6(int32 bpp__EntryPoint__pf)
{
...
void AShip_C__pf668171628::bpf__ExecuteUbergraph_Ship__pf_7(int32 bpp__EntryPoint__pf)
{
...
void AShip_C__pf668171628::bpf__ExecuteUbergraph_Ship__pf_8(int32 bpp__EntryPoint__pf)
{
...
void AShip_C__pf668171628::bpf__ExecuteUbergraph_Ship__pf_9(int32 bpp__EntryPoint__pf)
{
...
void AShip_C__pf668171628::bpf__ExecuteUbergraph_Ship__pf_10(int32 bpp__EntryPoint__pf)
{
	int32 __CurrentState = bpp__EntryPoint__pf;
	do
	{
...
void AShip_C__pf668171628::bpf__ExecuteUbergraph_Ship__pf_11(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 38);
	return; //KCST_EndOfThread
}
void AShip_C__pf668171628::bpf__ExecuteUbergraph_Ship__pf_12(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 37);
	return; //KCST_EndOfThread
}
void AShip_C__pf668171628::bpf__ExecuteUbergraph_Ship__pf_13(int32 bpp__EntryPoint__pf)
{
...
void AShip_C__pf668171628::bpf__ExecuteUbergraph_Ship__pf_14(int32 bpp__EntryPoint__pf)
{
...
void AShip_C__pf668171628::bpf__ExecuteUbergraph_Ship__pf_15(int32 bpp__EntryPoint__pf)
{
...
void AShip_C__pf668171628::bpf__ExecuteUbergraph_Ship__pf_16(int32 bpp__EntryPoint__pf)
{
...
void AShip_C__pf668171628::bpf__ReceiveDestroyed__pf()
{
	bpf__ExecuteUbergraph_Ship__pf_0(60);
}
void AShip_C__pf668171628::bpf__DestroyedxxServerxSidexStuff__pf3TTT_Implementation()
{
	bpf__ExecuteUbergraph_Ship__pf_5(56);
}
void AShip_C__pf668171628::bpf__BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_Ship__pf_1(49);
}
void AShip_C__pf668171628::bpf__ClientReplicate__pf_Implementation(FVector bpp__NewLocation__pf, FRotator bpp__NewRotation__pf)
{
	b0l__K2Node_CustomEvent_NewLocation__pf = bpp__NewLocation__pf;
	b0l__K2Node_CustomEvent_NewRotation__pf = bpp__NewRotation__pf;
	bpf__ExecuteUbergraph_Ship__pf_9(46);
}
void AShip_C__pf668171628::bpf__ServerTick__pf_Implementation(FVector bpp__Location__pf, FRotator bpp__Rotation__pf, float bpp__Tilt__pf)
{
	...
	bpf__ExecuteUbergraph_Ship__pf_7(39);
}
void AShip_C__pf668171628::bpf__Shield__pf()
{
	bpf__ExecuteUbergraph_Ship__pf_11(38);
}
void AShip_C__pf668171628::bpf__HyperWarp__pf()
{
	bpf__ExecuteUbergraph_Ship__pf_12(37);
}
void AShip_C__pf668171628::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_Ship__pf_6(29);
}
void AShip_C__pf668171628::bpf__ClienToggleThrust__pf_Implementation(bool bpp__acceleratex__pfzy)
{
	b0l__K2Node_CustomEvent_accelerate___pf = bpp__acceleratex__pfzy;
	bpf__ExecuteUbergraph_Ship__pf_14(24);
}
void AShip_C__pf668171628::bpf__ServerToggleThrust__pf_Implementation(bool bpp__acceleratex__pfzy)
{
	b0l__K2Node_CustomEvent_accelerate_1__pf = bpp__acceleratex__pfzy;
	bpf__ExecuteUbergraph_Ship__pf_15(21);
}
void AShip_C__pf668171628::bpf__Server_FireWeapon__pf_Implementation(bool bpp__IsFiring__pf)
{
	b0l__K2Node_CustomEvent_IsFiring__pf = bpp__IsFiring__pf;
	bpf__ExecuteUbergraph_Ship__pf_2(13);
}
void AShip_C__pf668171628::bpf__InpActEvt_Thrust_K2Node_InputActionEvent_7__pf(FKey bpp__Key__pf)
{
	b0l__K2Node_InputActionEvent_Key__pf = bpp__Key__pf;
	bpf__ExecuteUbergraph_Ship__pf_10(4);
}
void AShip_C__pf668171628::bpf__InpActEvt_Thrust_K2Node_InputActionEvent_8__pf(FKey bpp__Key__pf)
{
	b0l__K2Node_InputActionEvent_Key1__pf = bpp__Key__pf;
	bpf__ExecuteUbergraph_Ship__pf_10(44);
}
void AShip_C__pf668171628::bpf__InpActEvt_RotatexLeft_K2Node_InputActionEvent_9__pfT(FKey bpp__Key__pf)
{
	b0l__K2Node_InputActionEvent_Key2__pf = bpp__Key__pf;
	bpf__ExecuteUbergraph_Ship__pf_3(63);
}
void AShip_C__pf668171628::bpf__InpActEvt_RotatexLeft_K2Node_InputActionEvent_10__pfT(FKey bpp__Key__pf)
{
	b0l__K2Node_InputActionEvent_Key3__pf = bpp__Key__pf;
	bpf__ExecuteUbergraph_Ship__pf_4(1);
}
void AShip_C__pf668171628::bpf__InpActEvt_RotatexRight_K2Node_InputActionEvent_11__pfT(FKey bpp__Key__pf)
{
	b0l__K2Node_InputActionEvent_Key4__pf = bpp__Key__pf;
	bpf__ExecuteUbergraph_Ship__pf_16(18);
}
void AShip_C__pf668171628::bpf__InpActEvt_RotatexRight_K2Node_InputActionEvent_12__pfT(FKey bpp__Key__pf)
{
	b0l__K2Node_InputActionEvent_Key5__pf = bpp__Key__pf;
	bpf__ExecuteUbergraph_Ship__pf_13(27);
}
void AShip_C__pf668171628::bpf__InpActEvt_FirexWeapon_K2Node_InputActionEvent_13__pfT(FKey bpp__Key__pf)
{
	b0l__K2Node_InputActionEvent_Key6__pf = bpp__Key__pf;
	bpf__ExecuteUbergraph_Ship__pf_8(48);
}
void AShip_C__pf668171628::bpf__UserConstructionScript__pf()
{
	UMaterialInstanceDynamic* bpfv__CallFunc_CreateDynamicMaterialInstance_ReturnValue__pf{};
	if(::IsValid(bpv__StaticMesh__pf))
	{
		bpfv__CallFunc_CreateDynamicMaterialInstance_ReturnValue__pf = bpv__StaticMesh__pf->CreateDynamicMaterialInstance(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AShip_C__pf668171628::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	}
...
void AShip_C__pf668171628::bpf__HandleThrust__pf(float bpp__DeltaSeconds__pf)
{
...
void AShip_C__pf668171628::bpf__HandleRotation__pf()
{
	float bpfv__CallFunc_Multiply_FloatFloat_ReturnValue__pf{};
	FRotator bpfv__CallFunc_MakeRotator_ReturnValue__pf(EForceInit::ForceInit);
...
void AShip_C__pf668171628::bpf__OnRep_ShipColor__pf()
{
	if(::IsValid(bpv__ShipMat_Inst__pf))
	{
		bpv__ShipMat_Inst__pf->UMaterialInstanceDynamic::SetVectorParameterValue(FName(TEXT("Color")), bpv__ShipColor__pf);
...
void AShip_C__pf668171628::bpf__ToggleThrusters__pf()
{
...
void AShip_C__pf668171628::bpf__OnRep_acceleratex__pfzy()
{
}
PRAGMA_DISABLE_OPTIMIZATION
void AShip_C__pf668171628::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{0, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Game/Pawns/Ship/Mesh/TR-3B_III.TR-3B_III 
		{1, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Material /Game/Pawns/Ship/Material/ShipMat.ShipMat 
		{2, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  ParticleSystem /Game/_Imported/ParagonHowitzer/FX/Particles/Abilities/Mobility/FX/P_HB_Mobility_TravelMode_FootJets.P_HB_Mobility_TravelMode_FootJets 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AShip_C__pf668171628::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{5, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, true, false)},  //  Class /Script/Engine.ParticleSystemComponent 
		...
		{7, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  ScriptStruct /Script/InputCore.Key 
		...
		{11, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.GameModeBase 
		...
		{16, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.Pawn 
		{17, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.KismetStringLibrary 
		{18, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.MaterialInstanceDynamic 
		{19, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/AIModule.AIController 
		{20, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Pawns/Ship/BP_Projectile.BP_Projectile_C 
		{21, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Enemy/Alien.Alien_C 
		{22, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Obstacles/Asteroid.Asteroid_C 
		{23, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Modes/Debug/DebugMode.DebugMode_C 
		...
		{26, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  UserDefinedEnum /Game/Pawns/Ship/SRotate.SRotate 
	};
	for(const FCompactBlueprintDependencyData& CompactData : LocCompactBlueprintDependencyData)
	{
		AssetsToLoad.Add(FBlueprintDependencyData(F__NativeDependencies::Get(CompactData.ObjectRefIndex), CompactData));
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AShip_C__pf668171628
{
	FRegisterHelper__AShip_C__pf668171628()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Pawns/Ship/Ship"), &AShip_C__pf668171628::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AShip_C__pf668171628 Instance;
};
FRegisterHelper__AShip_C__pf668171628 FRegisterHelper__AShip_C__pf668171628::Instance;
void AShip_C__pf668171628::GetLifetimeReplicatedProps(TArray< FLifetimeProperty > & OutLifetimeProps) const
{
	Super::GetLifetimeReplicatedProps(OutLifetimeProps);
	DOREPLIFETIME_DIFFNAMES(AShip_C__pf668171628, bpv__ShipColor__pf, FName(TEXT("ShipColor")));
	DOREPLIFETIME_DIFFNAMES(AShip_C__pf668171628, bpv__MissleCount__pf, FName(TEXT("MissleCount")));
}
