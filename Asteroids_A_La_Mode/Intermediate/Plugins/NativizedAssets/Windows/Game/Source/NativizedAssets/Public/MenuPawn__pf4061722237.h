...
#include "MenuPawn__pf4061722237.generated.h"
UCLASS(config=Game, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Player/MenuPawn.MenuPawn_C", OverrideNativeName="MenuPawn_C"))
class AMenuPawn_C__pf4061722237 : public APawn
{
public:
	GENERATED_BODY()
	...
	AMenuPawn_C__pf4061722237(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
