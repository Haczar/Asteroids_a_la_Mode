		...
		case 22:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess7__pf = (b0l__K2Node_DynamicCast_AsShip1__pf != nullptr);;
...
void ABP_Projectile_C__pf668171628::bpf__ExecuteUbergraph_BP_Projectile__pf_3(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 7:
			{
				b0l__K2Node_DynamicCast_AsAsteroid_Small__pf = NoNativeCast<AAsteroid_C__pf2772898577>(CastChecked<UClass>(CastChecked<UDynamicClass>(ABP_Projectile_C__pf668171628::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed), b0l__K2Node_CustomEvent_Object_Collided__pf);
				b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsAsteroid_Small__pf != nullptr);;
		...
		case 8:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess3__pf = (b0l__K2Node_DynamicCast_AsDebug_MData__pf != nullptr);;
				FName  __Local__2 = FName();
				bpfv__CallFunc_EqualEqual_NameName_ReturnValue__pf = UKismetMathLibrary::EqualEqual_NameName(((::IsValid(b0l__K2Node_DynamicCast_AsUser_Data__pf)) ? (b0l__K2Node_DynamicCast_AsUser_Data__pf->bpv__PlyrxName__pfT) : (__Local__2)), FName(TEXT("Player One")));
		...
		case 9:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess5__pf = (b0l__K2Node_DynamicCast_AsShip__pf != nullptr);;
		...
		case 10:
			{
				int32  __Local__3 = 0;
				bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf = UKismetMathLibrary::Subtract_IntInt(((::IsValid(b0l__K2Node_DynamicCast_AsShip__pf)) ? (b0l__K2Node_DynamicCast_AsShip__pf->bpv__MissleCount__pf) : (__Local__3)), 1);
		...
		case 12:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess1__pf = (b0l__K2Node_DynamicCast_AsAsteroid_Medium__pf != nullptr);;
		...
		case 14:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess2__pf = (b0l__K2Node_DynamicCast_AsAsteroid_Large__pf != nullptr);;
		...
		case 16:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess4__pf = (b0l__K2Node_DynamicCast_AsReg_User__pf != nullptr);;
				...
				b0l__K2Node_DynamicCast_bSuccess6__pf = (b0l__K2Node_DynamicCast_AsUser_Data__pf != nullptr);;
...
{
	bpf__ExecuteUbergraph_BP_Projectile__pf_3(19);
}
