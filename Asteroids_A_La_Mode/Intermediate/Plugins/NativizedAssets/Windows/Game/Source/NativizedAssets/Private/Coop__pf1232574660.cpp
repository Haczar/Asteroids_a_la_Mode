...
UCoop_C__pf1232574660::UCoop_C__pf1232574660(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (UCoop_C__pf1232574660::StaticClass() == GetClass()))
	{
		UCoop_C__pf1232574660::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	
	bpv__Asteroids__pf = nullptr;
	bpv__Back__pf = nullptr;
	bpv__HostGame__pf = nullptr;
	bpv__JoinGame__pf = nullptr;
	bpv__TextxBack__pfG = nullptr;
	bpv__TextxHostGame__pfG = nullptr;
	bpv__TextxJoinGame__pfG = nullptr;
	bpv__CoOpxSelection__pfT = E__ECoOpSel__pf::NewEnumerator0;
	bCanEverTick = false;
	bCanEverPaint = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void UCoop_C__pf1232574660::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UCoop_C__pf1232574660::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__3 = NewObject<UCanvasPanelSlot>(__Local__1, UCanvasPanelSlot::StaticClass(), TEXT("CanvasPanelSlot_8"));
	...
	auto __Local__6 = NewObject<UVerticalBoxSlot>(__Local__4, UVerticalBoxSlot::StaticClass(), TEXT("VerticalBoxSlot_8"));
	...
	auto __Local__9 = NewObject<UScaleBoxSlot>(__Local__7, UScaleBoxSlot::StaticClass(), TEXT("ScaleBoxSlot_0"));
	__Local__9->Parent = __Local__7;
	auto __Local__10 = NewObject<UButton>(__Local__0, UButton::StaticClass(), TEXT("HostGame"));
	...
	auto __Local__12 = NewObject<UButtonSlot>(__Local__10, UButtonSlot::StaticClass(), TEXT("ButtonSlot_0"));
	__Local__12->Parent = __Local__10;
	auto __Local__13 = NewObject<UTextBlock>(__Local__0, UTextBlock::StaticClass(), TEXT("Text-HostGame"));
	...
	TEXT(""), /* Namespace */
	TEXT("D212B4D94881178ADC527B8210F96D0F") /* Key */
	);
	...
	__Local__13->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UCoop_C__pf1232574660::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	auto __Local__18 = NewObject<UScaleBox>(__Local__0, UScaleBox::StaticClass(), TEXT("Menu_Item"));
	...
	auto __Local__21 = NewObject<UButton>(__Local__0, UButton::StaticClass(), TEXT("JoinGame"));
	__Local__21->BackgroundColor = FLinearColor(1.000000, 0.000000, 0.000000, 0.000000);
	...
	auto __Local__23 = NewObject<UButtonSlot>(__Local__21, UButtonSlot::StaticClass(), TEXT("ButtonSlot_1"));
	__Local__23->Parent = __Local__21;
	auto __Local__24 = NewObject<UTextBlock>(__Local__0, UTextBlock::StaticClass(), TEXT("Text-JoinGame"));
	__Local__24->Text = FInternationalization::ForUseOnlyByLocMacroAndGraphNodeTextLiterals_CreateText(
	TEXT("Join Game"), /* Literal Text */
	TEXT(""), /* Namespace */
	TEXT("63BD32514EB8C145CD50D39CA068BD41") /* Key */
	);
	...
	__Local__24->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UCoop_C__pf1232574660::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	__Local__27->Size = FVector2D(1.000000, 75.000000);
	__Local__27->Slot = __Local__26;
	__Local__26->Content = __Local__27;
	__Local__5.Add(__Local__26);
	auto __Local__28 = NewObject<UVerticalBoxSlot>(__Local__4, UVerticalBoxSlot::StaticClass(), TEXT("VerticalBoxSlot_6"));
	__Local__28->Parent = __Local__4;
	auto __Local__29 = NewObject<UScaleBox>(__Local__0, UScaleBox::StaticClass(), TEXT("Menu_Item_"));
	...
	auto __Local__31 = NewObject<UScaleBoxSlot>(__Local__29, UScaleBoxSlot::StaticClass(), TEXT("ScaleBoxSlot_2"));
	...
	auto __Local__32 = NewObject<UButton>(__Local__0, UButton::StaticClass(), TEXT("Back"));
	__Local__32->BackgroundColor = FLinearColor(1.000000, 0.000000, 0.000000, 0.000000);
	...
	auto __Local__34 = NewObject<UButtonSlot>(__Local__32, UButtonSlot::StaticClass(), TEXT("ButtonSlot_2"));
	__Local__34->Parent = __Local__32;
	auto __Local__35 = NewObject<UTextBlock>(__Local__0, UTextBlock::StaticClass(), TEXT("Text-Back"));
	__Local__35->Text = FInternationalization::ForUseOnlyByLocMacroAndGraphNodeTextLiterals_CreateText(
	TEXT("Back"), /* Literal Text */
	TEXT(""), /* Namespace */
	TEXT("423519E747E7DBEE576265A24FA9FAA6") /* Key */
	);
	...
	__Local__35->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UCoop_C__pf1232574660::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	auto __Local__37 = NewObject<UCanvasPanelSlot>(__Local__1, UCanvasPanelSlot::StaticClass(), TEXT("CanvasPanelSlot_11"));
	__Local__37->LayoutData.Offsets.Right = 1020.000000f;
	__Local__37->LayoutData.Offsets.Bottom = 100.000000f;
	__Local__37->LayoutData.Anchors.Minimum = FVector2D(0.500000, 0.300000);
	__Local__37->LayoutData.Anchors.Maximum = FVector2D(0.500000, 0.300000);
	__Local__37->LayoutData.Alignment = FVector2D(0.500000, 0.500000);
	__Local__37->Parent = __Local__1;
	auto __Local__38 = NewObject<UScaleBox>(__Local__0, UScaleBox::StaticClass(), TEXT("TitleScale"));
	__Local__38->bSingleLayoutPass = false;
	...
	auto __Local__40 = NewObject<UScaleBoxSlot>(__Local__38, UScaleBoxSlot::StaticClass(), TEXT("ScaleBoxSlot_0"));
	__Local__40->Parent = __Local__38;
	auto __Local__41 = NewObject<UTextBlock>(__Local__0, UTextBlock::StaticClass(), TEXT("Asteroids"));
	...
	TEXT(""), /* Namespace */
	TEXT("F847CFE545EDFD4CFD4C89B5530DF0EF") /* Key */
	);
	__Local__41->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UCoop_C__pf1232574660::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
...
PRAGMA_ENABLE_OPTIMIZATION
void UCoop_C__pf1232574660::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__42;
	SlotNames.Append(__Local__42);
}
void UCoop_C__pf1232574660::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__43;
	TArray<FDelegateRuntimeBinding>  __Local__44;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), false, CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UCoop_C__pf1232574660::StaticClass())->MiscConvertedSubobjects[0]), __Local__43, __Local__44);
}
void UCoop_C__pf1232574660::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void UCoop_C__pf1232574660::bpf__ExecuteUbergraph_Coop__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 15:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("Menu Select called.")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
			}
		case 16:
			{
				b0l__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__CoOpxSelection__pfT), static_cast<uint8>(E__ECoOpSel__pf::NewEnumerator0));
				if (!b0l__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 1;
					break;
				}
				b0l__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__CoOpxSelection__pfT), static_cast<uint8>(E__ECoOpSel__pf::NewEnumerator1));
				if (!b0l__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 17;
					break;
				}
				b0l__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__CoOpxSelection__pfT), static_cast<uint8>(E__ECoOpSel__pf::NewEnumerator2));
				if (!b0l__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 19;
					break;
...
void UCoop_C__pf1232574660::bpf__ExecuteUbergraph_Coop__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	UKismetSystemLibrary::PrintString(this, FString(TEXT("Menu Down called.")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
	...
	bpfv__CallFunc_Less_ByteByte_ReturnValue__pf = UKismetMathLibrary::Less_ByteByte(static_cast<uint8>(bpv__CoOpxSelection__pfT), bpfv__CallFunc_Conv_IntToByte_ReturnValue__pf);
	if (!bpfv__CallFunc_Less_ByteByte_ReturnValue__pf)
	{
		return; //KCST_GotoReturnIfNot
	}
	bpf__RevertxAlphaxxMenuxItemx__pfTTLTK();
	bpfv__CallFunc_Add_ByteByte_ReturnValue__pf = UKismetMathLibrary::Add_ByteByte(static_cast<uint8>(bpv__CoOpxSelection__pfT), 1);
	bpfv__CallFunc_GetValidValue_ReturnValue1__pf = UKismetNodeHelperLibrary::GetValidValue(CastChecked<UEnum>(CastChecked<UDynamicClass>(UCoop_C__pf1232574660::StaticClass())->ReferencedConvertedFields[0]), bpfv__CallFunc_Add_ByteByte_ReturnValue__pf);
	bpv__CoOpxSelection__pfT = static_cast<E__ECoOpSel__pf>(bpfv__CallFunc_GetValidValue_ReturnValue1__pf);
	// optimized KCST_UnconditionalGoto
	bpf__SetxAlphaxxMenuxItemx__pfTTLTK(bpv__CoOpxSelection__pfT);
	return; // KCST_GotoReturn
}
void UCoop_C__pf1232574660::bpf__ExecuteUbergraph_Coop__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	// optimized KCST_UnconditionalGoto
	UKismetSystemLibrary::PrintString(this, FString(TEXT("Menu Up called.")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
	bpfv__CallFunc_Greater_ByteByte_ReturnValue__pf = UKismetMathLibrary::Greater_ByteByte(static_cast<uint8>(bpv__CoOpxSelection__pfT), 0);
	if (!bpfv__CallFunc_Greater_ByteByte_ReturnValue__pf)
	{
		return; //KCST_GotoReturnIfNot
	}
	bpf__RevertxAlphaxxMenuxItemx__pfTTLTK();
	bpfv__CallFunc_Subtract_ByteByte_ReturnValue__pf = UKismetMathLibrary::Subtract_ByteByte(static_cast<uint8>(bpv__CoOpxSelection__pfT), 1);
	bpfv__CallFunc_GetValidValue_ReturnValue__pf = UKismetNodeHelperLibrary::GetValidValue(CastChecked<UEnum>(CastChecked<UDynamicClass>(UCoop_C__pf1232574660::StaticClass())->ReferencedConvertedFields[0]), bpfv__CallFunc_Subtract_ByteByte_ReturnValue__pf);
	bpv__CoOpxSelection__pfT = static_cast<E__ECoOpSel__pf>(bpfv__CallFunc_GetValidValue_ReturnValue__pf);
	bpf__SetxAlphaxxMenuxItemx__pfTTLTK(bpv__CoOpxSelection__pfT);
	return; // KCST_GotoReturn
}
void UCoop_C__pf1232574660::bpf__ExecuteUbergraph_Coop__pf_3(int32 bpp__EntryPoint__pf)
{
...
void UCoop_C__pf1232574660::bpf__ExecuteUbergraph_Coop__pf_4(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 24);
	// optimized KCST_UnconditionalGoto
	UKismetSystemLibrary::PrintString(this, FString(TEXT("Coop Menu loaded.")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
	...
	bpf__SetxObjxxColorxandxOpacity__pfT3TTT(bpv__TextxHostGame__pfG, b0l__K2Node_MakeStruct_SlateColor__pf);
	bpv__CoOpxSelection__pfT = E__ECoOpSel__pf::NewEnumerator0;
	return; // KCST_GotoReturn
}
void UCoop_C__pf1232574660::bpf__Construct__pf()
{
	bpf__ExecuteUbergraph_Coop__pf_4(24);
}
void UCoop_C__pf1232574660::bpf__MenuxBack__pfT()
{
	bpf__ExecuteUbergraph_Coop__pf_3(20);
}
void UCoop_C__pf1232574660::bpf__MenuxSelect__pfT()
{
	bpf__ExecuteUbergraph_Coop__pf_0(14);
}
void UCoop_C__pf1232574660::bpf__MovexDown__pfT()
{
	bpf__ExecuteUbergraph_Coop__pf_1(9);
}
void UCoop_C__pf1232574660::bpf__MovexUp__pfT()
{
	bpf__ExecuteUbergraph_Coop__pf_2(3);
}
void UCoop_C__pf1232574660::bpf__SetxObjxxColorxandxOpacity__pfT3TTT(UTextBlock* bpp__TextxObj__pfT, FSlateColor bpp__ColorxandxAlpha__pfTT)
{
		...
		case 1:
			{
				...
				{
					bpp__TextxObj__pfT->UTextBlock::SetColorAndOpacity(bpp__ColorxandxAlpha__pfTT);
				}
			}
		case 2:
			{
...
void UCoop_C__pf1232574660::bpf__RevertxAlphaxxMenuxItemx__pfTTLTK()
{
	...
	do
	{
		...
		case 1:
			{
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__CoOpxSelection__pfT), static_cast<uint8>(E__ECoOpSel__pf::NewEnumerator0));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 2;
					break;
				}
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__CoOpxSelection__pfT), static_cast<uint8>(E__ECoOpSel__pf::NewEnumerator1));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 3;
					break;
				}
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__CoOpxSelection__pfT), static_cast<uint8>(E__ECoOpSel__pf::NewEnumerator2));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 4;
					break;
		...
		case 2:
			{
				...
				bpf__SetxObjxxColorxandxOpacity__pfT3TTT(bpv__TextxHostGame__pfG, bpfv__K2Node_MakeStruct_SlateColor__pf);
				__CurrentState = -1;
				break;
			}
		case 3:
			{
				(*(AccessPrivateProperty<FLinearColor >(&(bpfv__K2Node_MakeStruct_SlateColor__pf), FSlateColor::__PPO__SpecifiedColor() ))) = FLinearColor(1.000000,1.000000,1.000000,0.500000);
				(*(AccessPrivateProperty<TEnumAsByte<ESlateColorStylingMode::Type> >(&(bpfv__K2Node_MakeStruct_SlateColor__pf), FSlateColor::__PPO__ColorUseRule() ))) = ESlateColorStylingMode::UseColor_Specified;
				bpf__SetxObjxxColorxandxOpacity__pfT3TTT(bpv__TextxJoinGame__pfG, bpfv__K2Node_MakeStruct_SlateColor__pf);
				__CurrentState = -1;
				break;
			}
		case 4:
			{
				(*(AccessPrivateProperty<FLinearColor >(&(bpfv__K2Node_MakeStruct_SlateColor__pf), FSlateColor::__PPO__SpecifiedColor() ))) = FLinearColor(1.000000,1.000000,1.000000,0.500000);
				(*(AccessPrivateProperty<TEnumAsByte<ESlateColorStylingMode::Type> >(&(bpfv__K2Node_MakeStruct_SlateColor__pf), FSlateColor::__PPO__ColorUseRule() ))) = ESlateColorStylingMode::UseColor_Specified;
				bpf__SetxObjxxColorxandxOpacity__pfT3TTT(bpv__TextxBack__pfG, bpfv__K2Node_MakeStruct_SlateColor__pf);
				__CurrentState = -1;
				break;
			}
		default:
...
void UCoop_C__pf1232574660::bpf__SetxAlphaxxMenuxItemx__pfTTLTK(E__ECoOpSel__pf bpp__Selection__pf)
{
	bool bpfv__K2Node_SwitchEnum_CmpSuccess__pf{};
	FSlateColor bpfv__K2Node_MakeStruct_SlateColor__pf{};
	int32 __CurrentState = 1;
	do
	{
		...
		case 1:
			{
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpp__Selection__pf), static_cast<uint8>(E__ECoOpSel__pf::NewEnumerator0));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 2;
					break;
				}
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpp__Selection__pf), static_cast<uint8>(E__ECoOpSel__pf::NewEnumerator1));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 3;
					break;
				}
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpp__Selection__pf), static_cast<uint8>(E__ECoOpSel__pf::NewEnumerator2));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 4;
					break;
...
PRAGMA_DISABLE_OPTIMIZATION
void UCoop_C__pf1232574660::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UCoop_C__pf1232574660::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UCoop_C__pf1232574660
{
	FRegisterHelper__UCoop_C__pf1232574660()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/UserInterface/MainScreen/Coop"), &UCoop_C__pf1232574660::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UCoop_C__pf1232574660 Instance;
};
FRegisterHelper__UCoop_C__pf1232574660 FRegisterHelper__UCoop_C__pf1232574660::Instance;
