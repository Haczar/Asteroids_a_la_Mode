...
UDebugManager_C__pf4162722864::UDebugManager_C__pf4162722864(const FObjectInitializer& ObjectInitializer) : Super()
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (UDebugManager_C__pf4162722864::StaticClass() == GetClass()))
	{
		UDebugManager_C__pf4162722864::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
...
void UDebugManager_C__pf4162722864::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UDebugManager_C__pf4162722864::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void UDebugManager_C__pf4162722864::bpf__ExecuteUbergraph_DebugManager__pf_0(int32 bpp__EntryPoint__pf)
{
...
void UDebugManager_C__pf4162722864::bpf__ExecuteUbergraph_DebugManager__pf_1(int32 bpp__EntryPoint__pf)
{
	FText bpfv__CallFunc_MakeLiteralText_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 85);
	// optimized KCST_UnconditionalGoto
	UKismetSystemLibrary::PrintString(this, FString(TEXT("Load settings called.")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
	...
	TEXT(""), /* Namespace */
	TEXT("2B1CCBF047543642E25C2DB74FE30537") /* Key */
	));
...
void UDebugManager_C__pf4162722864::bpf__ExecuteUbergraph_DebugManager__pf_2(int32 bpp__EntryPoint__pf)
{
...
void UDebugManager_C__pf4162722864::bpf__ExecuteUbergraph_DebugManager__pf_3(int32 bpp__EntryPoint__pf)
{
...
void UDebugManager_C__pf4162722864::bpf__ExecuteUbergraph_DebugManager__pf_4(int32 bpp__EntryPoint__pf)
{
...
void UDebugManager_C__pf4162722864::bpf__ExecuteUbergraph_DebugManager__pf_5(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 37);
	// optimized KCST_UnconditionalGoto
	UKismetSystemLibrary::PrintString(this, FString(TEXT("Leave game called.")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
	bpf__DestroySesh__pf();
	bpf__SetxDebugMxtoxMainScreen__pfTTT();
	return; //KCST_EndOfThread
}
void UDebugManager_C__pf4162722864::bpf__ExecuteUbergraph_DebugManager__pf_6(int32 bpp__EntryPoint__pf)
{
	APlayerController* bpfv__CallFunc_GetPlayerController_ReturnValue2__pf{};
	check(bpp__EntryPoint__pf == 30);
	// optimized KCST_UnconditionalGoto
	UKismetSystemLibrary::PrintString(this, FString(TEXT("Join game called.")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
	bpfv__CallFunc_GetPlayerController_ReturnValue2__pf = UGameplayStatics::GetPlayerController(this, 0);
	b0l__K2Node_DynamicCast_AsReg_User1__pf = Cast<ARegUser_C__pf4061722237>(bpfv__CallFunc_GetPlayerController_ReturnValue2__pf);
	b0l__K2Node_DynamicCast_bSuccess1__pf = (b0l__K2Node_DynamicCast_AsReg_User1__pf != nullptr);;
	b0l__CallFunc_JoinSession_ReturnValue__pf = UJoinSessionCallbackProxy::JoinSession(this, b0l__K2Node_DynamicCast_AsReg_User1__pf, b0l__K2Node_CustomEvent_Session_to_join__pf);
...
void UDebugManager_C__pf4162722864::bpf__ExecuteUbergraph_DebugManager__pf_7(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 71);
	// optimized KCST_UnconditionalGoto
	UKismetSystemLibrary::Delay(this, 0.000001, FLatentActionInfo(-1, -1664046845, TEXT("ExecuteUbergraph_DebugManager"), this));
	return; //KCST_EndOfThread
}
void UDebugManager_C__pf4162722864::bpf__ExecuteUbergraph_DebugManager__pf_8(int32 bpp__EntryPoint__pf)
{
	...
	b0l__K2Node_DynamicCast_AsReg_User2__pf = Cast<ARegUser_C__pf4061722237>(bpfv__CallFunc_GetPlayerController_ReturnValue3__pf);
	b0l__K2Node_DynamicCast_bSuccess2__pf = (b0l__K2Node_DynamicCast_AsReg_User2__pf != nullptr);;
	b0l__CallFunc_FindSessions_ReturnValue__pf = UFindSessionsCallbackProxy::FindSessions(this, b0l__K2Node_DynamicCast_AsReg_User2__pf, 1, bpv__Lanx__pfzy);
...
void UDebugManager_C__pf4162722864::bpf__ExecuteUbergraph_DebugManager__pf_9(int32 bpp__EntryPoint__pf)
{
...
void UDebugManager_C__pf4162722864::bpf__ExecuteUbergraph_DebugManager__pf_10(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 68);
	return; //KCST_EndOfThread
}
void UDebugManager_C__pf4162722864::bpf__ExecuteUbergraph_DebugManager__pf_11(int32 bpp__EntryPoint__pf)
{
	...
	b0l__CallFunc_CreateSession_ReturnValue__pf = UCreateSessionCallbackProxy::CreateSession(this, b0l__K2Node_DynamicCast_AsReg_User__pf, 10, bpv__Lanx__pfzy);
...
void UDebugManager_C__pf4162722864::bpf__ExecuteUbergraph_DebugManager__pf_12(int32 bpp__EntryPoint__pf)
{
...
void UDebugManager_C__pf4162722864::bpf__ExecuteUbergraph_DebugManager__pf_13(int32 bpp__EntryPoint__pf)
{
...
void UDebugManager_C__pf4162722864::bpf__ExecuteUbergraph_DebugManager__pf_14(int32 bpp__EntryPoint__pf)
{
...
void UDebugManager_C__pf4162722864::bpf__ExecuteUbergraph_DebugManager__pf_15(int32 bpp__EntryPoint__pf)
{
...
void UDebugManager_C__pf4162722864::bpf__ExecuteUbergraph_DebugManager__pf_16(int32 bpp__EntryPoint__pf)
{
...
void UDebugManager_C__pf4162722864::bpf__ExecuteUbergraph_DebugManager__pf_17(int32 bpp__EntryPoint__pf)
{
...
void UDebugManager_C__pf4162722864::bpf__ExecuteUbergraph_DebugManager__pf_18(int32 bpp__EntryPoint__pf)
{
...
void UDebugManager_C__pf4162722864::bpf__ExecuteUbergraph_DebugManager__pf_19(int32 bpp__EntryPoint__pf)
{
	int32 __CurrentState = bpp__EntryPoint__pf;
	do
	{
...
void UDebugManager_C__pf4162722864::bpf__ExecuteUbergraph_DebugManager__pf_20(int32 bpp__EntryPoint__pf)
{
...
void UDebugManager_C__pf4162722864::bpf__LoadxSettings__pfT_Implementation()
{
	bpf__ExecuteUbergraph_DebugManager__pf_1(85);
}
void UDebugManager_C__pf4162722864::bpf__SetxDebugMxtoxArcade1979__pfTTT_Implementation()
{
	bpf__ExecuteUbergraph_DebugManager__pf_0(81);
}
void UDebugManager_C__pf4162722864::bpf__SetxDebugMxtoxDebugMode__pfTTT_Implementation()
{
	bpf__ExecuteUbergraph_DebugManager__pf_2(77);
}
void UDebugManager_C__pf4162722864::bpf__SetxDebugMxtoxMainScreen__pfTTT_Implementation()
{
	bpf__ExecuteUbergraph_DebugManager__pf_3(73);
}
void UDebugManager_C__pf4162722864::bpf__ReceiveInit__pf()
{
	bpf__ExecuteUbergraph_DebugManager__pf_7(71);
}
void UDebugManager_C__pf4162722864::bpf__ShowLoadingScreen__pf()
{
	bpf__ExecuteUbergraph_DebugManager__pf_10(68);
}
void UDebugManager_C__pf4162722864::bpf__HandleTravelError__pf(ETravelFailure::Type bpp__FailureType__pf)
{
	b0l__K2Node_Event_FailureType__pf = bpp__FailureType__pf;
	bpf__ExecuteUbergraph_DebugManager__pf_20(66);
}
void UDebugManager_C__pf4162722864::bpf__HandleNetworkError__pf(ENetworkFailure::Type bpp__FailureType__pf, bool bpp__bIsServer__pf)
{
	b0l__K2Node_Event_FailureType1__pf = bpp__FailureType__pf;
	b0l__K2Node_Event_bIsServer__pf = bpp__bIsServer__pf;
	bpf__ExecuteUbergraph_DebugManager__pf_19(63);
}
void UDebugManager_C__pf4162722864::bpf__DestroySesh__pf_Implementation()
{
	bpf__ExecuteUbergraph_DebugManager__pf_17(56);
}
void UDebugManager_C__pf4162722864::bpf__FindxGames__pfT_Implementation()
{
	bpf__ExecuteUbergraph_DebugManager__pf_8(48);
}
void UDebugManager_C__pf4162722864::bpf__CreatexCoop__pfT_Implementation()
{
	bpf__ExecuteUbergraph_DebugManager__pf_11(41);
}
void UDebugManager_C__pf4162722864::bpf__LeavexGame__pfT_Implementation()
{
	bpf__ExecuteUbergraph_DebugManager__pf_5(37);
}
void UDebugManager_C__pf4162722864::bpf__JoinxGame__pfT_Implementation(FBlueprintSessionResult bpp__Sessionxtoxjoin__pfTT)
{
	b0l__K2Node_CustomEvent_Session_to_join__pf = bpp__Sessionxtoxjoin__pfTT;
	bpf__ExecuteUbergraph_DebugManager__pf_6(30);
}
void UDebugManager_C__pf4162722864::bpf__OnSuccess_D98B94BC46FD2DBCEB07728CAE0BB77F__pf()
{
	bpf__ExecuteUbergraph_DebugManager__pf_12(25);
}
void UDebugManager_C__pf4162722864::bpf__OnFailure_D98B94BC46FD2DBCEB07728CAE0BB77F__pf()
{
	bpf__ExecuteUbergraph_DebugManager__pf_13(23);
}
void UDebugManager_C__pf4162722864::bpf__OnSuccess_50E2515040AAF84455FDB1ADB5219E72__pf()
{
	bpf__ExecuteUbergraph_DebugManager__pf_16(21);
}
void UDebugManager_C__pf4162722864::bpf__OnFailure_50E2515040AAF84455FDB1ADB5219E72__pf()
{
	bpf__ExecuteUbergraph_DebugManager__pf_15(19);
}
void UDebugManager_C__pf4162722864::bpf__OnSuccess_8AFB58C5443B5AFADD60D0925753A253__pf(TArray<FBlueprintSessionResult> const& bpp__Results__pf__const)
{
	...
	bpf__ExecuteUbergraph_DebugManager__pf_4(7);
}
void UDebugManager_C__pf4162722864::bpf__OnFailure_8AFB58C5443B5AFADD60D0925753A253__pf(TArray<FBlueprintSessionResult> const& bpp__Results__pf__const)
{
	typedef TArray<FBlueprintSessionResult>  T__Local__2;
	T__Local__2& bpp__Results__pf = *const_cast<T__Local__2 *>(&bpp__Results__pf__const);
	b0l__K2Node_CustomEvent_Results1__pf = bpp__Results__pf;
	bpf__ExecuteUbergraph_DebugManager__pf_18(4);
}
void UDebugManager_C__pf4162722864::bpf__OnSuccess_7C4156FE49C8B859B34E9083CCA81E0E__pf()
{
	bpf__ExecuteUbergraph_DebugManager__pf_14(27);
}
void UDebugManager_C__pf4162722864::bpf__OnFailure_7C4156FE49C8B859B34E9083CCA81E0E__pf()
{
	bpf__ExecuteUbergraph_DebugManager__pf_9(70);
}
void UDebugManager_C__pf4162722864::bpf__ChangexState__pfT(E__DStates__pf bpp__DesiredxState__pfT)
{
	...
	do
	{
		...
		case 2:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsDebug_MData__pf))
				{
					bpfv__K2Node_DynamicCast_AsDebug_MData__pf->bpf__SetxState__pfT(bpp__DesiredxState__pfT);
				}
				__CurrentState = -1;
				break;
			}
...
void UDebugManager_C__pf4162722864::bpf__LoadxLevel__pfT(const FString& bpp__LevelxName__pfT__const)
{
	typedef FString  T__Local__3;
	T__Local__3& bpp__LevelxName__pfT = *const_cast<T__Local__3 *>(&bpp__LevelxName__pfT__const);
...
void UDebugManager_C__pf4162722864::bpf__NetErrorxtoxString__pfTT(ENetworkFailure::Type bpp__NetxError__pfT, /*out*/ FString& bpp__ErrorxText__pfT)
{
...
void UDebugManager_C__pf4162722864::bpf__TravelErrorxtoxString__pfTT(ETravelFailure::Type bpp__TravelError__pf, /*out*/ FString& bpp__Error__pf)
{
	FString bpfv__CallFunc_GetEnumeratorUserFriendlyName_ReturnValue__pf{};
	FString bpfv__CallFunc_Concat_StrStr_ReturnValue__pf{};
	bpfv__CallFunc_GetEnumeratorUserFriendlyName_ReturnValue__pf = UKismetNodeHelperLibrary::GetEnumeratorUserFriendlyName(CastChecked<UEnum>(CastChecked<UDynamicClass>(UDebugManager_C__pf4162722864::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed), static_cast<uint8>(bpp__TravelError__pf));
...
PRAGMA_DISABLE_OPTIMIZATION
void UDebugManager_C__pf4162722864::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UDebugManager_C__pf4162722864::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UDebugManager_C__pf4162722864
{
	FRegisterHelper__UDebugManager_C__pf4162722864()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Modes/Debug/DebugManager"), &UDebugManager_C__pf4162722864::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UDebugManager_C__pf4162722864 Instance;
};
FRegisterHelper__UDebugManager_C__pf4162722864 FRegisterHelper__UDebugManager_C__pf4162722864::Instance;
