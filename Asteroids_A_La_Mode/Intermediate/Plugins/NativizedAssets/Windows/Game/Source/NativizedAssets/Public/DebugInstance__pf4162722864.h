...
#include "DebugInstance__pf4162722864.generated.h"
UCLASS(config=Game, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Modes/Debug/DebugInstance.DebugInstance_C", OverrideNativeName="DebugInstance_C"))
class UDebugInstance_C__pf4162722864 : public UGameInstance
{
public:
	GENERATED_BODY()
	...
	UDebugInstance_C__pf4162722864(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_DebugInstance__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_DebugInstance__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_DebugInstance__pf_2(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_DebugInstance__pf_3(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_DebugInstance__pf_4(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_DebugInstance__pf_5(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_DebugInstance__pf_6(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_DebugInstance__pf_7(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_DebugInstance__pf_8(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_DebugInstance__pf_9(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_DebugInstance__pf_10(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_DebugInstance__pf_11(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_DebugInstance__pf_12(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_DebugInstance__pf_13(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_DebugInstance__pf_14(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_DebugInstance__pf_15(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_DebugInstance__pf_16(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_DebugInstance__pf_17(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_DebugInstance__pf_18(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_DebugInstance__pf_19(int32 bpp__EntryPoint__pf);
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="Load Settings"))
	...
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="Set DebugM to MainScreen"))
	...
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="DestroySesh"))
	virtual void bpf__DestroySesh__pf();
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="Find Games"))
	...
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="Leave Game"))
	virtual void bpf__LeavexGame__pfT();
	UFUNCTION(Server, BlueprintCallable, Unreliable, meta=(Category, OverrideNativeName="Join Game"))
