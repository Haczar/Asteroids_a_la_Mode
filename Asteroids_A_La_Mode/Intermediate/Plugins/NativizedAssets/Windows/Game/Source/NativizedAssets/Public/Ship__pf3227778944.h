...
#include "Ship__pf3227778944.generated.h"
UCLASS(config=Game, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Ship/Ship.Ship_C", OverrideNativeName="Ship_C"))
class AShip_C__pf3227778944 : public APawn
{
public:
	GENERATED_BODY()
	...
	AShip_C__pf3227778944(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	...
	UFUNCTION(Server, Reliable, BlueprintCallable, meta=(Category, OverrideNativeName="Destory Ship"))
	virtual void bpf__DestoryxShip__pfT();
