...
#include "Public/SRotate__pf3227778944.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeSRotate__pf3227778944() {}
...
// End Cross Module References
	...
	{
		class UPackage* EnumPackage = FindOrConstructDynamicTypePackage(TEXT("/Game/Ship/SRotate"));
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_E__SRotate__pf(E__SRotate__pf_StaticEnum, TEXT("/Game/Ship/SRotate"), TEXT("SRotate"), true, TEXT("/Game/Ship/SRotate"), TEXT("/Game/Ship/SRotate.SRotate"));
	uint32 Get_Z_Construct_UEnum_NativizedAssets_E__SRotate__pf_CRC() { return 2402032185U; }
	UEnum* Z_Construct_UEnum_NativizedAssets_E__SRotate__pf()
	{
		UPackage* Outer = FindOrConstructDynamicTypePackage(TEXT("/Game/Ship/SRotate"));		UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("SRotate"), 0, Get_Z_Construct_UEnum_NativizedAssets_E__SRotate__pf_CRC(), true);
		if (!ReturnEnum)
		{
			...
			static const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "ModuleRelativePath", "Public/SRotate__pf3227778944.h" },
				...
				{ "ReplaceConverted", "/Game/Ship/SRotate.SRotate" },
			};
#endif
			static const UE4CodeGen_Private::FEnumParams EnumParams = {
				(UObject*(*)())[](){ return (UObject*)FindOrConstructDynamicTypePackage(TEXT("/Game/Ship/SRotate")); },
