...
#define ORIGINAL_FILE_NAME "UE4Editor-Asteroids_aLaMode.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME Asteroids_aLaMode
#define DEPRECATED_FORGAME DEPRECATED
#define ASTEROIDS_ALAMODE_API DLLEXPORT
